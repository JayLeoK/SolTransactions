...
import {
  require_prop_types
} from "./chunk-AGCIR6RY.js";
import {
  __assign,
  __rest
} from "./chunk-QP2RZLYT.js";
import {
  _extends
} from "./chunk-KBUAZBQ3.js";
import "./chunk-T5KIXIUK.js";
import {
...
var RemoveScroll = React13.forwardRef(function(props, parentRef) {
  ...
  return React13.createElement(
    ...
    forwardProps ? React13.cloneElement(React13.Children.only(children), __assign2({}, containerProps, { ref: containerRef })) : React13.createElement(Container, __assign2({}, containerProps, { className, ref: containerRef }), children)
  );
});
...
var ReactRemoveScroll = React17.forwardRef(function(props, ref) {
  return React17.createElement(RemoveScroll, __assign2({}, props, { ref, sideCar: sidecar_default }));
});
...
function DialogWrapper({
  ...
  return React18.createElement(Portal, {
    ...
    ...props
  }, React18.createElement(DialogContextProvider, {
    isOpen
  }, children));
}
DialogWrapper.displayName = "unstable_DialogWrapper";
var DialogInner = React18.forwardRef(function DialogInner2({
  allowPinchZoom,
  as: Comp = "div",
  ...
  const overlayNode = React18.useRef(null);
  const ref = useComposedRefs(overlayNode, forwardedRef);
  const activateFocusLock = React18.useCallback(() => {
  ...
  return React18.createElement(es2015_default2, {
    autoFocus: true,
    returnFocus: true,
...
var DialogOverlay = React18.forwardRef(function DialogOverlay2({ as: Comp = "div", isOpen = true, ...props }, forwardedRef) {
  return isOpen ? React18.createElement(DialogWrapper, {
    isOpen
  }, React18.createElement(DialogInner, {
...
var DialogContent = React18.forwardRef(function DialogContent2({ as: Comp = "div", onClick, onKeyDown, ...props }, forwardedRef) {
  let { isOpen } = useDialogContext("DialogContent");
  return React18.createElement(Comp, {
    "aria-modal": "true",
    role: "dialog",
    tabIndex: -1,
    ...props,
...
var Dialog = React18.forwardRef(function Dialog2({
  ...
  return React18.createElement(DialogOverlay, {
    allowPinchZoom,
    initialFocusRef,
    isOpen,
    onDismiss
  }, React18.createElement(DialogContent, {
    ref: forwardedRef,
    ...props
  }));
});
